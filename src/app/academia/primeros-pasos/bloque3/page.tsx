/**
 * @project CEN - Nivel 3: Lección Individual (Bloque 3)
 * @author Cristofer Huerta (Luminar)
 * @description Clon de alta fidelidad del Bloque 3 (Necesidades vs Deseos).
 */
...
export default function Bloque3Page() {
  return (
    <main className="min-h-screen bg-white font-epilogue overflow-x-hidden">
      ...
      {/* 2. HERO DEL BLOQUE (Paleta Azul Claro/Blanco) */}
      <section className="pt-32 pb-20 px-6 max-w-4xl mx-auto flex flex-col items-center text-center">
        <div className="bg-gradient-to-b from-[#E0F2FE] to-white w-full rounded-[4.5rem] p-12 shadow-xl border border-blue-50 relative overflow-hidden mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-[#011C40] tracking-tighter mb-6">
            Necesidades vs. Deseos: <br/> ¡A Comprar con Inteligencia!
          </h1>
          <p className="text-slate-500 font-bold text-sm leading-relaxed max-w-2xl mx-auto">
            Aprende a diferenciar entre lo que realmente necesitas para vivir y lo que solo deseas. Acompaña a CENy a tomar las mejores decisiones de compra.
          </p>
        </div>

        <h3 className="text-[#0980E8] font-black text-xl mb-6 tracking-tighter">En Este Bloque Aprenderemos</h3>
        <div className="flex flex-wrap justify-center gap-4 mb-16">
           <span className="bg-[#FFFBEB] text-[#B45309] border border-[#FCD34D] px-6 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-sm">Necesidad</span>
           <span className="bg-[#FFFBEB] text-[#B45309] border border-[#FCD34D] px-6 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-sm">Deseo</span>
           <span className="bg-[#FFFBEB] text-[#B45309] border border-[#FCD34D] px-6 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-sm">Prioridad</span>
        </div>

        {/* Tarjeta de Introducción */}
        <div className="w-full max-w-2xl bg-gradient-to-r from-[#818CF8] to-[#A78BFA] rounded-[3rem] p-10 flex items-center justify-center border-4 border-white shadow-xl mb-16 h-64 font-black text-white/80 text-xl">
           [ IMG Tarjeta Espacio/CENy ]
        </div>
      </section>
      ...
      {/* 4. ZONA AZUL PROFUNDA: JUEGOS Y RETOS */}
      <section className="w-full bg-[#0980E8] py-24 px-6 relative">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
           
           <h2 className="text-3xl md:text-4xl font-black text-white tracking-tighter mb-16 leading-tight">
             ¡Nos vemos en el próximo <br/> video para una historia <br/> <span className="text-[#FFCA28]">muy especial!</span>
           </h2>

           {/* Juego 1: Identifica tu compra */}
           <div className="w-full bg-white rounded-[4.5rem] p-8 shadow-2xl mb-16 hover:-translate-y-2 transition-transform border-4 border-white/10">
              <h3 className="text-2xl font-black text-[#011C40] tracking-tighter mb-2">Mi Lista de Compras</h3>
              <p className="text-slate-500 font-bold text-sm mb-8">Elige qué artículos son realmente necesarios.</p>
           ...
           {/* Juego 2: Clasificador interactivo */}
           <div className="w-full bg-white rounded-[4.5rem] p-8 shadow-2xl mb-24 hover:-translate-y-2 transition-transform border-4 border-white/10">
              <h3 className="text-2xl font-black text-[#011C40] tracking-tighter mb-2">Clasifica: ¿Necesidad o Deseo?</h3>
              <p className="text-slate-500 font-bold text-sm mb-8">Arrastra cada objeto a su caja correspondiente.</p>
           ...
           <div className="w-full flex flex-col items-center">
              ...
              {/* Audio Player adaptado a tema azul */}
              <div className="w-full max-w-2xl bg-white/10 backdrop-blur-md rounded-full p-4 flex items-center gap-4 border border-white/20 shadow-xl mb-20">
                 ...
                 <span className="text-white font-black text-xs tracking-widest">04:20 / 05:45</span>
              </div>
           ...
           {/* 6. PROYECTOS FINALES */}
           <div className="w-full border-t-4 border-white/10 pt-20 flex flex-col items-center">
              ...
              <p className="text-white font-bold uppercase tracking-widest text-xs mb-12 max-w-md">
                Aplica lo aprendido. Descarga las plantillas y comienza a comprar con inteligencia.
              </p>
              ...
              <div className="flex flex-col md:flex-row justify-center gap-6 w-full mb-16">
                 <div className="bg-white rounded-[2.5rem] p-8 flex-1 shadow-2xl hover:-translate-y-2 transition-transform cursor-pointer border-4 border-transparent hover:border-white/50">
                    ...
                    <h3 className="font-black text-[#011C40] mb-2 uppercase tracking-widest text-sm">Lista de Compras</h3>
                 </div>
                 <div className="bg-white rounded-[2.5rem] p-8 flex-1 shadow-2xl hover:-translate-y-2 transition-transform cursor-pointer border-4 border-transparent hover:border-white/50">
                    <div className="w-16 h-16 bg-[#0980E8]/10 text-[#0980E8] rounded-full flex items-center justify-center mx-auto mb-6 font-black text-2xl">↓</div>
                    <h3 className="font-black text-[#011C40] mb-2 uppercase tracking-widest text-sm">Recorta y Clasifica</h3>
                 </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
                 ...
                 <Link href="/academia/primeros-pasos/bloque4">
