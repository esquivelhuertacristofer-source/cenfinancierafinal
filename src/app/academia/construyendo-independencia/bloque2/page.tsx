/**
 * @project CEN - Nivel 3: Construyendo Independencia (Bloque 2)
 * @author Cristofer Huerta (Luminar)
 * @description Clon de alta fidelidad del Segmento 2, Bloque 2 (La Deuda).
 */

import Link from "next/link";

export default function Segmento2Bloque2Page() {
  return (
    <main className="min-h-screen bg-white font-epilogue overflow-x-hidden">
      ...
      {/* 2. HERO DEL BLOQUE (Rosa Suave a Blanco) */}
      <section className="pt-32 pb-20 px-6 max-w-4xl mx-auto flex flex-col items-center text-center">
        <div className="bg-gradient-to-b from-[#FCE7F3] to-white w-full rounded-[4.5rem] p-12 shadow-xl border border-pink-50 relative overflow-hidden mb-12">
          <span className="bg-[#F472B6] text-white px-6 py-2 rounded-full font-black text-[10px] uppercase tracking-widest mb-4 inline-block shadow-md">
            Bloque 2
          </span>
          <h1 className="text-4xl md:text-5xl font-black text-[#831843] tracking-tighter mb-6">
            La Deuda: Tu Aliada o <br/> Tu Enemiga
          </h1>
          <p className="text-slate-500 font-bold text-sm leading-relaxed max-w-2xl mx-auto">
            Descubre que no todas las deudas son malas. Aprende la diferencia entre un crédito que te ayuda a crecer y uno que te atrapa, y toma el control de tu historial.
          </p>
        </div>

        <h3 className="text-[#F472B6] font-black text-xl mb-6 tracking-tighter">En Este Bloque Aprenderemos</h3>
        <div className="flex flex-wrap justify-center gap-4 mb-16">
           <span className="bg-[#FFF1F2] text-[#BE123C] border border-[#FDA4AF] px-6 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-sm">El Crédito</span>
           <span className="bg-[#FFF1F2] text-[#BE123C] border border-[#FDA4AF] px-6 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-sm">El Interés</span>
           <span className="bg-[#FFF1F2] text-[#BE123C] border border-[#FDA4AF] px-6 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-sm">La Responsabilidad</span>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20 text-center">
        ...
        <div className="w-full aspect-video bg-slate-100 rounded-[4.5rem] shadow-2xl overflow-hidden flex items-center justify-center border-8 border-slate-50 relative">
           <div className="absolute inset-0 flex items-center justify-center flex-col">
              <div className="w-20 h-20 bg-[#F472B6] rounded-full flex items-center justify-center shadow-lg shadow-pink-500/50 mb-4 pl-2 cursor-pointer hover:scale-110 transition-transform">
      ...
      {/* 4. ZONA ROSA VIBRANTE: JUEGOS Y RECURSOS */}
      <section className="w-full bg-[#FB7185] py-24 px-6 relative">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
           ...
           <div className="w-full bg-[#F59E0B] rounded-[4.5rem] p-6 shadow-2xl hover:-translate-y-2 transition-transform border-4 border-white/20 mb-16">
              <h3 className="text-2xl font-black text-[#011C40] tracking-tighter mb-2 mt-4">Mide Tus Gastos y Controla La Energía</h3>
              <p className="text-[#011C40]/80 font-bold text-sm mb-6">Equilibra la balanza para no caer en deudas malas.</p>
           ...
           <div className="w-full bg-[#0EA5E9] rounded-[4.5rem] p-6 shadow-2xl mb-24 hover:-translate-y-2 transition-transform border-4 border-white/20">
              <h3 className="text-2xl font-black text-white tracking-tighter mb-2 mt-4">Desafía Tu Conocimiento Financiero</h3>
              <p className="text-white/80 font-bold text-sm mb-6">Demuestra que sabes usar el crédito a tu favor.</p>
           ...
           <div className="w-full flex flex-col items-center">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-white tracking-tighter mb-8 drop-shadow-sm">
                 La Historia a Cuenta Gotas: <br/> <span className="text-[#FFCA28]">De cómo la imagen pasó a realidad</span>
              </h2>
              ...
              <div className="w-full max-w-2xl bg-white/30 backdrop-blur-md rounded-full p-4 flex items-center gap-4 border border-white/50 shadow-xl mb-20">
                 <div className="w-12 h-12 bg-[#FFCA28] rounded-full flex items-center justify-center shrink-0 cursor-pointer hover:scale-105 transition-transform">
                    <div className="w-0 h-0 border-t-[8px] border-t-transparent border-l-[12px] border-l-[#BE123C] border-b-[8px] border-b-transparent ml-1"></div>
                 </div>
                 ...
                 <span className="text-white font-black text-xs tracking-widest">04:10 / 06:45</span>
              </div>
              ...
              <h3 className="text-2xl font-black text-white tracking-tighter mb-8 drop-shadow-sm">Guía del Bloque (Lo que no te dijeron sobre la Deuda)</h3>
      ...
      <section className="w-full bg-[#0980E8] pt-24 pb-20 px-6">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            <p className="text-white/80 font-bold uppercase tracking-widest text-xs mb-12 max-w-lg">
              ¿Has prestado atención a la lección sobre deudas buenas? Descarga las plantillas y comienza a calcular qué intereses son verdaderamente un aporte.
            </p>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6 w-full mb-16">
               <div className="bg-white rounded-[2.5rem] p-8 flex-1 shadow-2xl hover:-translate-y-2 transition-transform cursor-pointer border-4 border-transparent hover:border-white/50">
                  ...
                  <h3 className="font-black text-[#011C40] mb-2 uppercase tracking-widest text-sm">Simulador de Intereses</h3>
               </div>
               <div className="bg-white rounded-[2.5rem] p-8 flex-1 shadow-2xl hover:-translate-y-2 transition-transform cursor-pointer border-4 border-transparent hover:border-white/50">
                  <div className="w-16 h-16 bg-[#0980E8]/10 text-[#0980E8] rounded-full flex items-center justify-center mx-auto mb-6 font-black text-2xl">↓</div>
                  <h3 className="font-black text-[#011C40] mb-2 uppercase tracking-widest text-sm">Mi Mapa de Crédito</h3>
               </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
               ...
               <Link href="/academia/construyendo-independencia/bloque3">
      ...
      {/* 6. ACCESO A BIBLIOTECA (Footer en Rosa Vibrante) */}
      <section className="w-full bg-[#FB7185] pt-16 pb-32 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-16">
           <div className="text-white md:w-1/2 text-center md:text-left">
              <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tighter leading-tight">
                 Acceso a la <br/> <span className="text-[#831843]/80">biblioteca</span>
              </h2>
              <p className="font-bold text-sm text-[#831843] leading-relaxed mb-8 max-w-sm mx-auto md:mx-0">
              ...
              <button className="bg-[#831843] text-white px-8 py-4 rounded-full font-black shadow-xl hover:scale-105 transition-all uppercase text-xs">
                 Accede Ahora
              </button>
           </div>
